...
export default function FontFields({ bolded: isBolded, italicized: isItalicized }) {
  ...
  const inactive = 'text-gray-200 hover:text-white bg-gray-900 hover:bg-gray-700 focus:bg-gray-700 border-gray-700 hover:border-gray-500 focus:border-gray-500';
