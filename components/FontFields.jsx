...
export default function FontFields({ bolded: isBolded, italicized: isItalicized }) {
  ...
  const classes = 'flex items-center justify-center border h-6 w-6 focus:ring-1 focus:ring-gray-100 focus:outline-none hover:scale-[108%] focus:scale-[108%] active:scale-100';
