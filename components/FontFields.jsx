...
export default function FontFields({ bolded: isBolded, italicized: isItalicized }) {
  ...
  const classes = 'border-box h-6 flex items-center justify-center border h-6 w-6 focus:ring-1 focus:ring-gray-100 focus:outline-none hover:scale-[108%] focus:scale-[108%] active:scale-100 transition duration-75';
  // const classes = 'h-6 flex items-center justify-center border h-6 w-6 focus:ring-1 focus:ring-gray-100 focus:outline-none hover:scale-[108%] focus:scale-[108%] active:scale-100 transition duration-75';
  const active = `text-black bg-gray-100 hover:bg-white focus:bg-white border-gray-100 hover:border-white focus:border-white`;
  const inactive = 'text-gray-200 bg-gray-900 hover:bg-gray-700 focus:bg-gray-700 border-gray-700 hover:border-gray-500 focus:border-gray-500';
