...
export default function StyleEditor({ styles, width }) {
  ...
  return (
    <section className={`
      max-w-[260px] overflow-y-scroll shadow-xl md:shadow-none absolute md:static bottom-1.5 z-20  pt-12 px-1 pb-4 md:p-0 md:pt-2.5 bg-black/90 backdrop-blur md:h-auto rounded-xl md:rounded-none border border-white/[15%] md:border-none
