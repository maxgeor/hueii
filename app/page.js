  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-y-12 my-6">
        <section className={`${maxWidth} flex flex-col items-center gap-y-9`}>
          ...
          <div className="flex flex-col items-center gap-y-4">
            ...
            <p className="text-gray-500">or <a href="#" className="ml-1 underline underline-offset-4 decoration-gray-500 hover:decoration-white font-medium text-white">Sign In</a></p>
          </div>
        </section>
        <section>
